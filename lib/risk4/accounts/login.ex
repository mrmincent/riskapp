defmodule Risk4.Accounts.Login do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Risk4.Repo)
  ...
  """
  def valid_password?(%Risk4.Accounts.Login{hashed_password: hashed_password}, password)
